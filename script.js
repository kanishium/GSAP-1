...
function weareanime() {
  ...
  tl6.from(".page-3 .who h1", {
    x: -200,
    stagger: 1,
    duration: 2
  }, "he")
  tl6.from(".page-3 .we-are h1", {
    x: 300,
    stagger: 1,
    duration: 2
  }, "he")
...
function partneranime() {
  ...
  tl6.from(".page-4 .who h1", {
    x: -200,
    // stagger:1,
    duration: 3
  }, "he")
  tl6.from(".page-4 .we-are h1", {
    x: -200,
    // stagger:1,
    delay: 2,
    duration: 3,
...
function socials() {
  ...
  socials.forEach((element, index) => {
    element.addEventListener("mouseenter", function () {
      ...
      const firstImage = soc[index].querySelector(".soc-icon");
      gsap.to(firstImage, {
        rotateZ: "180deg",
        duration: 1
      })
